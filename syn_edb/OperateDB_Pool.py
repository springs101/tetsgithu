...
class OperateDB_Pool:
    ...
    def groupData(self, groupDic):
        ...
        for val in groupDic:
            ...
            for i in self.objectArray:
                node.append(val[i])
            self.outputobjecArrayOrder.append(node)
        return
    ...
    def handitemorder(self):
        self.delItem = 'delete from s_order_item where tid ='
